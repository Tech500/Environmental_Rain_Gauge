///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 
//                       Version  3.3  'RainGauge.ino' 09/12/2021 @ 06:41 EDT  Developed by William  M. Lucid, techno500
...
void setup(void)
{
  ...
  Serial.println("");
  Serial.println("\n\nVersion  3.3  'RainGauge.ino' 09/12/2021 @ 06:41 EDT");
...
void loop() 
{
  ...
  if ((WiFi.status() != WL_CONNECTED) || (WiFi.status() == WL_NO_SSID_AVAIL)  || (WiFi.status() == WL_CONNECTION_LOST))
  {
  ...
  if (reconnect == 1)
  {
    ...
    if(started == 1)
    {
      ...
      logFile.print("ESP32 Started:        ");  //Created for Power on restarts and may log Brown out restarts too...
